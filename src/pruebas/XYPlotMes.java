...
//http://code.google.com/p/test-chart/source/browse/trunk/src/main/java/es/efor/plandifor/demo/TimeSeriesDemo11.java?spec=svn2&r=2
//http://code.google.com/p/chart4me/source/browse/trunk/chart4me/demo/org/skzr/chart4me/demo/time/?r=28
package pruebas;
...
public class XYPlotMes extends ApplicationFrame {

    public XYPlotMes(String s) {
        super(s);
    ...
    public static void main(String args[]) {
        XYPlotMes xyplotmes = new XYPlotMes("Time Series Demo 11");
        xyplotmes.pack();
        RefineryUtilities.centerFrameOnScreen(xyplotmes);
        xyplotmes.setVisible(true);
    }
}